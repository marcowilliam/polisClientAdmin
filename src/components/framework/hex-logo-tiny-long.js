...
class PolisLogo extends React.Component {
  ...
  render() {
    return (
        ...
        <svg width="120px" height="53px" viewBox="0 0 120 53" style={{"backgroundColor": "#03A9F4"}}>
          <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
              <g id="Artboard-7-Copy-7">
                  <g id="Group" transform="translate(3.000000, 3.000000)">
                    <polygon id="Polygon-1" fill="#FFFFFF" points="20.4588192 0 40.9176384 11.75 40.9176384 35.25 20.4588192 47 9.6261623e-15 35.25 -3.55271368e-15 11.75"></polygon>
                    <path d="M5.85714286,13.9834711 L7.41904762,17.8677686" id="Line" stroke="#FFFFFF" strokeWidth="0.3" strokeLinecap="square"></path>
                    <text id="p." fontFamily="Georgia" fontSize="27" fontWeight="normal" fill="#03A9F4">
                    ...
                    <path d="M16.2047619,8.35123967 L23.0380952,10.4876033" id="Line" stroke="#FFFFFF" strokeWidth="0.3" strokeLinecap="square"></path>
                    <path d="M14.8380952,10.8760331 L16.0095238,8.54545455" id="Line" stroke="#FFFFFF" strokeWidth="0.3" strokeLinecap="square"></path>
                  </g>
                  <text id="pol.is" fontFamily="Georgia" fontSize="27" fontWeight="normal" fill="#FFFFFF">
                    <tspan x="54" y="31">pol.is</tspan>
                  </text>
              </g>
          </g>
        </svg>
